...
def calculates_results_stats(results_dic):
    ...
    """        
    #1. Create an empty dictionary - results_stats_dic
    results_stats_dic = dict()
    #1. Set all counters to initial values of zero so that they can 
    ...
    #3. process through the results dictionary
    for key in results_dic:
         
        #4. Check if the Labels Match Exactly
